...
struct CraftPageView: View {
    ...
    @State private var showGIFsInsteadOfBackgrounds = false
    @State private var selectedIsGif = false
    ...
    private let backgrounds = ["bg1", "bg2 1", "bg3", "bg4", "bg5"]
    private let gifs = ["Howdy", "HappyBirthday", "callMePenguin", "cheering", "MissYou"]
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 20) {
                ...
                VStack(alignment: .leading, spacing: 10) {
                    HStack {
                        Text(showGIFsInsteadOfBackgrounds ? "GIFs" : "Background")
                            .font(.custom("Cantora One", size: 18))
                            .foregroundColor(Color(hex: "530000"))
                        ...
                        Button(action: {
                            showGIFsInsteadOfBackgrounds.toggle()
                        }) {
                            Text(showGIFsInsteadOfBackgrounds ? "Show Backgrounds" : "Show GIFs")
                    ...
                    ScrollView(.horizontal, showsIndicators: false) {
                        HStack(spacing: 15) {
                            if showGIFsInsteadOfBackgrounds {
                                ForEach(gifs, id: \.self) { gif in
                                    ...
                                    .overlay(
                                        RoundedRectangle(cornerRadius: 10)
                                            .stroke(selectedBackground == gif ? Color.black : Color.clear, lineWidth: 2)
                                    )
                                    .frame(width: 80, height: 80)
                                    .onTapGesture {
                                        selectedBackground = gif
                                        selectedIsGif = true
                                    }
                                }
